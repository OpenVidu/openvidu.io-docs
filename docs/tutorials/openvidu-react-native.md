...
<div style="
    ...
    display: table-cell;
    padding: 10px 20px;">
    React Native support is a paid feature. <strong>A special version of openvidu-browser library is needed for openvidu-react-native tutorial to work</strong>. Contact us through <a href="https://openvidu.io/commercial">Commercial page support</a> to get it
</div>
</div>
