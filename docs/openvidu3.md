...
- In Connection objects the `subscribers` array will always be empty. This applies to the `subscribers` property in the JSON response of the [REST API](reference-docs/REST-API/#the-connection-object) methods, the [Connection#getSubscribers](/en/latest/api/openvidu-java-client/io/openvidu/java/client/Connection.html#getSubscribers()) method of openvidu-java-client, and the [Connection.subscribers](/en/latest/api/openvidu-node-client/classes/Connection.html#subscribers) property of openvidu-node-client.
...
- `reason` attribute is available but not accurate for events: [sessionDisconnected](/en/latest/api/openvidu-browser/classes/SessionDisconnectedEvent.html#reason), [connectionDestroyed](/en/latest/api/openvidu-browser/classes/ConnectionEvent.html#reason), [streamDestroyed](/en/latest/api/openvidu-browser/classes/StreamEvent.html#reason) and [recordingStopped](/en/latest/api/openvidu-browser/classes/RecordingEvent.html#reason).
- When using [Network Quality API](advanced-features/network-quality/#understanding-the-network-quality-level), event [NetworkQualityLevelChanged](/en/latest/api/openvidu-browser/classes/NetworkQualityLevelChangedEvent.html) now returns only values ​​1,3 and 5 (never 2 or 4). Representing 5 good network, 3 average network and 1 poor network.
- Method [Stream.reconnect](/en/latest/api/openvidu-browser/classes/Stream.html#reconnect) exists but does nothing.
- ICE exception events are not generated. This means that [ExceptionEvent](/en/latest/api/openvidu-browser/classes/ExceptionEvent.html) will not be fired with event names [ICE_CANDIDATE_ERROR](/en/latest/api/openvidu-browser/enums/ExceptionEventName.html#ICE_CANDIDATE_ERROR), [ICE_CONNECTION_DISCONNECTED](/en/latest/api/openvidu-browser/enums/ExceptionEventName.html#ICE_CONNECTION_DISCONNECTED), [ICE_CONNECTION_FAILED](/en/latest/api/openvidu-browser/enums/ExceptionEventName.html#ICE_CONNECTION_FAILED).
