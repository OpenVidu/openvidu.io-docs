...
The openvidu-additional-panels tutorial is created for showing how we can add to the default panels a new additional panel with the aim of adapting the app to our needs.

This customization can be possible because of the the [**AdditionalPanelsDirective**](api/openvidu-angular/directives/AdditionalPanelsDirective.html) which provides us a simple way to customizing the [**PanelComponent**](api/openvidu-angular/components/PanelComponent.html).
