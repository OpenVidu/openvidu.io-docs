...
The openvidu-additional-panels tutorial shows how to add a new additional panel to the default panel group.

This customization is possible thanks to the [**AdditionalPanelsDirective**](reference-docs/openvidu-angular/directives/AdditionalPanelsDirective.html), which provides us a simple way of customizing the [**PanelComponent**](reference-docs/openvidu-angular/components/PanelComponent.html).
...
<div class="warningBoxContent">
  ...
  <div class="warningBoxText">
    openvidu-additional-panels is not production ready videconference app because it's using an insecure communication for requesting the token to OpenVidu Server. We highly recommend do this in the backend side.
  </div>
</div>
...
Inside of the __ov-videoconference__ component, we will add the custom template tagged with the __`*ovAdditionalPanels`__. You can see how the __`AdditionalPanelsDirective`__ works [here](/reference-docs/openvidu-angular/directives/AdditionalPanelsDirective.html).
