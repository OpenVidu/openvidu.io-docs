...
This customization is possible thanks to the [**ToolbarAdditionalPanelButtonsDirective**](/reference-docs/openvidu-angular/directives/ToolbarAdditionalPanelButtonsDirective.html), which provides us a simple way to customizing the [**ToolbarComponent**](/reference-docs/openvidu-angular/components/ToolbarComponent.html).
...
Inside of the __ov-videoconference__ component, we will add the custom template tagged with the __`*ovToolbarAdditionalPanelButtons`__. You can see how the __`ToolbarAdditionalPanelButtonsDirective`__ works [here](/reference-docs/openvidu-angular/directives/ToolbarAdditionalPanelButtonsDirective.html).
