...
In openvidu-custom-stream tutorial we are replacing the default stream and injecting our own with the aim of adapting the app to our needs. This customization can be possible because of the the [**StreamDirective**](api/openvidu-angular/directives/StreamDirective.html) which provides us a simple way to customizing the [**StreamComponent**](api/openvidu-angular/components/StreamComponent.html).
