...
The openvidu-custom-stream tutorial is created for showing how to replace the default stream and injecting our own with the aim of adapting the app to our needs.

This customization can be possible because of the the [**StreamDirective**](api/openvidu-angular/directives/StreamDirective.html) which provides us a simple way to customizing the [**StreamComponent**](api/openvidu-angular/components/StreamComponent.html).
...
<div class="warningBoxContent">
  ...
  <div class="warningBoxText">
    openvidu-custom-stream is not production ready videconference app because it's using an insecure communication for requesting the token to OpenVidu Server. We highly recommend do this in the backend side.
  </div>
</div>
...
Inside of the __ov-videoconference__ component, we will add the custom template tagged with the __`*ovStream`__. You can see how the __`StreamDirective`__ works [here](/api/openvidu-angular/directives/StreamDirective.html).
