...
In openvidu-custom-toolbar tutorial we are replacing the default toolbar and injecting our own with the aim of adapting the app to our needs. This customization can be possible because of the the [**ToolbarDirective**](/api/openvidu-angular/directives/ToolbarDirective.html) which provides us a simple way to replace and adapt the [**ToolbarComponent**](/api/openvidu-angular/components/ToolbarComponent.html).
