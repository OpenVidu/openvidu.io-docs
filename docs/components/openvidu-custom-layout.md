...
In openvidu-custom-layout tutorial we are replacing the default layout and injecting our own with the aim of adapting the app to our needs. This customization can be possible because of the the [**LayoutDirective**](/api/openvidu-angular/directives/LayoutDirective.html) which provides us a simple way to customizing the [**LayoutComponent**](/api/openvidu-angular/components/LayoutComponent.html).
