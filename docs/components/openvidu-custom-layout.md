...
This customization is possible thanks to the [**LayoutDirective**](/reference-docs/openvidu-angular/directives/LayoutDirective.html), which provides us a simple way to customizing the [**LayoutComponent**](/reference-docs/openvidu-angular/components/LayoutComponent.html).
...
Inside of the __ov-videoconference__ component, we will add the custom template tagged with the __`*ovLayout`__. You can see how the __`LayoutDirective`__ works [here](/reference-docs/openvidu-angular/directives/LayoutDirective.html).
