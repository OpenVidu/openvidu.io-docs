...
>
- [Self-signed certificate example](openvidu-pro/deployment/on-premises-ssl-examples/#1-self-signed-certificate)
- [Let's Encrypt certificate example](openvidu-pro/deployment/on-premises-ssl-examples/#2-lets-encrypt-certificate)
- [Custom Certificate example (Commercial CA)](openvidu-pro/deployment/on-premises-ssl-examples/#3-custom-certificate-commercial-ca)
