...
<div class="container">
  ...
  <div class="row feature-row">
    ...
    <div class="col-sm-6 col-xs-12 feature-text-col">
      ...
      <span class="feature-text">Browsers, Android, iOS<br><i>(Safari, Edge and iOS support coming soon)</i></span>
    </div>
  </div>
  <hr>
  <div class="row feature-row">
  ...
  <div class="row feature-row">
    ...
    <div class="col-sm-6 col-xs-12 feature-text-col">
      ...
      <span class="feature-text">We offer <a href="/docs/openvidu-pro/" target="_blank" style="font-weight: bold">OpenVidu Pro</a> for those companies interested in a more advanced production setup, focused on improved monitoring, scalability and fault tolerance. OpenVidu team is also opened to providing professional support for any project related to the platform</span>
    </div>
  </div>
