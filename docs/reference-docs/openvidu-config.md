...
| **`OPENVIDU_BROWSER_LOGS`** | If `OPENVIDU_BROWSER_LOGS=debug` all logs of clients/browsers related with OpenVidu using [openvidu-browser](reference-docs/openvidu-browser/) will be sent into Elasticsearch. | **disabled** |
