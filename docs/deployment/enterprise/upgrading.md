...
- **[Migrating from 2.24.0 to 2.25.1 (AWS Cloudformation - Single master deployment)](#migrating-from-2240-to-2251-aws-cloudformation-single-master-deployment)**
- **[Migrating from 2.24.0 to 2.25.1 (On premises - Single master deployment)](#migrating-from-2240-to-2251-on-premises-single-master-deployment)**
- **[Migrating from 2.24.0 to 2.25.1 (AWS Cloudformation - High Availability deployment)](#migrating-from-2240-to-2251-aws-cloudformation-high-availability-deployment)**

### Migrating from 2.24.0 to 2.25.1 (AWS Cloudformation - Single master deployment)
<br>

Upgrading process for this kind of deployment is exactly the same as [Migrating from 2.24.0 to 2.25.1 OpenVidu Pro (AWS with Cloudformation)](https://docs.openvidu.io/en/2.25.0/deployment/pro/upgrading/#migrating-from-2240-to-2251-aws-cloudformation).

> Remember to use `OPENVIDU_EDITION=enterprise` to run the deployment as OpenVidu enterprise.

### Migrating from 2.24.0 to 2.25.1 (On premises - Single master deployment)
<br>

Upgrading process for this kind of deployment is exactly the same as [Migrating from 2.24.0 to 2.25.1 OpenVidu Pro (On premises)](https://docs.openvidu.io/en/2.25.0/deployment/pro/upgrading/#migrating-from-2240-to-2251-on-premises).

> Remember to use `OPENVIDU_EDITION=enterprise` to run the deployment as OpenVidu enterprise.

### Migrating from 2.24.0 to 2.25.1 (AWS Cloudformation - High Availability deployment)
<br>
...
aws s3api create-bucket \
    --bucket <new-bucket-v2.25.1> \
    --region <your-region>
aws s3 sync s3://<bucket-v2.24.0> s3://<new-bucket-v2.25.1>
```
...
**3)** Deploy the Cloudformation template of 2.25.1 from [this instructions](https://docs.openvidu.io/en/2.25.0/deployment/enterprise/aws/#high-availability-deployment). If you've followed steps 1 and 2, put at the **`OpenVidu S3 bucket`** parameter your new bucket, otherwise just keep the parameter blank.
